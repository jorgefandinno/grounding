...
\begin{frame}{Disclaimer}
  \bigskip
  \begin{itemize}
  \item \structure{Scope} \ Grounding algorithms for normal logic programs\\(with integrity constraints)
  \end{itemize}
\end{frame}
% ----------------------------------------------------------------------
...
\begin{frame}{Essential concepts}
  ...
  \begin{itemize}
    ...
    \item \structure{Ground instance}  of a rule
      ...
      \end{itemize}
    \item \structure{Grounding instantiation} of a logic program
      \begin{itemize}\normalsize

...
\begin{frame}{Program dependencies}
  ...
  \item<2-> \structure{Positive dependency graph} of program \(P\)
    ...
    \end{itemize}
    \medskip
  \item<only@4-> \structure{Strongly connected components} \ of a directed graph form a partition into subgraphs
    in which each node is reachable from any other node
    \medskip
  \item<only@5-> \structure{Topological ordering} \  \(L_P = (C_{1,1},\dots,C_{1,m_1},\dots,C_{n,1},\dots,C_{n,m_n})\)
    \par
